package com.sportconnect.teamsservice.config.redisconfiguration;

import com.sportconnect.teamsservice.config.ConfigService;
...
public class RedisConfiguration {
    ...
    @Autowired
    public RedisConfiguration(ConfigService configService) {
